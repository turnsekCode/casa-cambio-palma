    ...
    <section className={styles.contenedorSectionTres}>
      <div className={styles.contenedorContenidoUno}>
        <div className={styles.bloqueIzq}>
          ...
          <p>
            <span>
              Actualmente tenemos 2 casas de cambio en Palma de Mallorca. Te
              esperamos para cambiar tu divisa y llevarte euros en efectivo y al
              instante.{" "}
            </span>
        ...
        <div className={styles.bloqueDer}>
          ...
          <p>
            Cambiar divisa en Quickgold Palma es muy sencillo. Visita nuestra
            casa de cambio, indícanos la divisa qué quieres cambiar y al momento
            podrás llevarte euros al mejor tipo de cambio en la capital de
            Mallorca.
          </p>
        </div>
      </div>
      <h1>
        Cambiar divisa en <span className={styles.linea}>Mallorca</span> es muy
        fácil
      </h1>
