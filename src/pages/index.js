...
const schema = {
  ...
  description:
    "Cambiar divisa en Palma es fácil y rápido. Tenemos más de 30 monedas disponibles para que cambies moneda extranjera en solo unos minutos.",
  address: {
    "@type": "PostalAddress",
  ...
  return (
    <>
      <Head>
        ...
        ></script>
        <title>
          Casas de Cambio en Palma | Cambio de Divisas Palma de Mallorca
        </title>
        <meta
          name="description"
